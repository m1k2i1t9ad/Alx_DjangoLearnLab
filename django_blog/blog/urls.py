...
from .views import PostListView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView,CommentCreateView,CommentUpdateView,CommentDeleteView,SearchView,PostsByTagView
...
urlpatterns = [
    ...
    path('tags/<str:tag_slug>/', views.PostsByTagView.as_view(), name='posts_by_tag'),  # URL for posts by tag
]