...
from .views import PostListView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView,CommentCreateView,CommentUpdateView,CommentDeleteView,SearchView,PostsByTagListView
...
urlpatterns = [
    ...
    path('tags/<slug:tag_slug>/', views.PostsByTagListView.as_view(), name='posts_by_tag'),  # URL for posts by tag
]